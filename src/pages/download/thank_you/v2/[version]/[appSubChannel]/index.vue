        ...
        <div v-else>
          ...
          <div class="d-flex flex-column gap-4 mb-4">
            <div class="input-group">
              ...
              <FluentTextBox readonly :model-value="downloadInfo.archiveUrl" append-icon="mdi-content-copy" @click:append="copyDownloadUrl"/>
            </div>
            <div class="input-group">
              <label class="fluent-label">校验和（SHA512）</label>
              <FluentTextBox readonly :model-value="downloadInfo.archiveSHA512" append-icon="mdi-content-copy" @click:append="copyChecksum"/>
            </div>
          </div>
        </div>
