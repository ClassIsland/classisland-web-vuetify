<template>
  <v-app-bar class="pr-4">
    <v-app-bar-title class="align-content-center">
      ClassIsland
    </v-app-bar-title>

    <template v-slot:append>
      <div class="ga-4  ">
        <v-btn href="https://migrate.classisland.tech/">
          迁移到 ClassIsland
        </v-btn>
        <v-btn href="https://docs.classisland.tech/">
          文档
        </v-btn>
  ...
  <div class=" position-relative" style="height: 100vh">
    <v-parallax src="../assets/screenshots/desktop.png" class="position-absolute" style="height: 100vh; width: 100vw; filter: blur(8px); opacity: 0.1"/>
    <div class="introduction position-absolute">
      <div class="description-container">
        ...
        <div class="d-flex ga-4">
          ...
          <v-btn flat large color="primary" prepend-icon="mdi-download"
                 onclick="">
            立即下载
          </v-btn>
          <v-btn flat prepend-icon="mdi-github"
      ...
      <div class="introduction-demo-container">
        <div class="position-absolute desktop-img">
          <img src="../assets/screenshots/desktop.png" style="height: 75vh; margin-top: 10vb;"/></div>
      </div>
  ...
  <v-sheet>
    <div class="content d-flex flex-1-1">
      <div class="d-flex flex-column ga-4 mr-4">
        ...
        <v-card title="显示当日的课表" variant="tonal" prepend-icon="mdi-table"
                text="ClassIsland 可以根据规则自动显示当天的课表，支持单双周轮换。"/>
        <v-card title="课程详细信息" variant="tonal" prepend-icon="mdi-text"
                text="ClassIsland 可以根据设置，展开显示当前课程的详细信息，如课程时间，下课计时等。"/>
        <v-card title="快速信息" variant="tonal" prepend-icon="mdi-card-text-outline"
  ...
  <div >
    <div class="content d-flex flex-1-1 align-content-center">
      <div class="flex-grow-1 mr-4 align-self-center" style="flex-basis: 0; width: 100%">
        ...
        >
          <v-carousel-item>
            <img src="../assets/screenshots/311477098-29d91bf2-4c8a-4cbd-a778-a9034e7d7420.png" width="100%"/>
          </v-carousel-item>
          <v-carousel-item>
            <img src="../assets/screenshots/311477113-2b3b5c87-c8bb-46f0-8470-01edf3ca52a2.png" width="100%"/>
          </v-carousel-item>
          <v-carousel-item>
            <img src="../assets/screenshots/311477126-a2e64983-dfa0-4565-a45a-31c9f9c298a8.png" width="100%"/>
          </v-carousel-item>
        </v-carousel>
      </div>
      <div class="d-flex flex-column ga-4 flex-grow-1 ml-4" style="flex-basis: 0">
        ...
        <div class="d-flex flex-column ga-4">
          <v-card title=" 简洁直观的课表编辑工具" variant="tonal" prepend-icon="mdi-file-document-edit-outline"
                  text="ClassIsland 具有简洁直观的课表编辑工具，可以便利地编辑课表、时间表和科目等信息。"
                  class="flex-grow-1 ">

          </v-card>
          <v-card title="课表导入" variant="tonal" prepend-icon="mdi-file-import-outline"
                  class="flex-grow-1 ">
            <v-card-text>
              ClassIsland 可以从学校发布的电子版课表表格文件中导入课表和时间表信息。除此之外，ClassIsland 也支持<a href="https://migrate.classisland.tech/">从其它课表软件导入课表信息</a>。
            </v-card-text>
          </v-card>
          <v-card title="换课与临时课表" variant="tonal" prepend-icon="mdi-swap-horizontal"
                  class="flex-grow-1 ">
            <v-card-text>
    ...
    <v-sheet>
      <div class="content d-flex flex-1-1">
        <div class="d-flex flex-column ga-4 flex-grow-1 mr-4" style="flex-basis: 0">
          <h2>提醒</h2>
          <p>ClassIsland 可以在上课、下课等重要时间点发出提醒。除此之外，ClassIsland支持使用一系列方法强调提醒效果。</p>
        ...
        <div class="flex-grow-1 d-flex ml-4 " style="flex-basis: 0">
          <div class="position-relative">
            <video src="../assets/notification-demo.mp4" muted autoplay loop
                   width="100%" id="notification-demo"/>
            <div class="position-absolute" style="bottom: 16px; left: 8px">
              <v-btn variant="elevated" color="primary" icon="mdi-volume-off"
                     id="button_unmute"
                     title="取消静音" @click="unmute_video"
                     v-if="!isVideoSoundRestored"/>
            </div>
          </div>
    ...
    <div class="">
      <div class="content d-flex flex-column ga-8">
        ...
        <div class="d-flex flex-row ga-2 align-self-center">
          <v-btn flat color="primary" prepend-icon="mdi-download"
                 onclick="">
            立即下载 ClassIsland
          </v-btn>
          <v-btn flat prepend-icon="mdi-github"
