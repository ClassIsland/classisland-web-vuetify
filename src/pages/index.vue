<template>
    ...
    <div class="introduction d-flex flex-column margin-x" style="z-index: 1">
      <div class="introduction-col description">
        ...
        <div class="d-flex ga-4 flex-wrap mt-2">
          <v-btn to="/download" color="blue-lighten-3" prepend-icon="mdi-download" size="large"
            >立即下载</v-btn
          >
          <v-btn
  ...
  <v-sheet class="content">
    <h2 class="headline-feature text-center">
      <span
        class="gradient-base"
        style="background-image: linear-gradient(135deg, #00ffed, #00bdfd)"
        >直观</span
      >
      <span>的信息显示</span>
    </h2>
    <div class="margin-x ga-4">
      ...
      <p class="mt-4">
        您可以通过【组件】自定义界面上显示的内容，并且支持组件轮播和多行组件。课表组件支持显示当天的课表和当前进行课程的信息。各种信息一目了然。
      </p>
      <div class="d-flex flex-column align-content-center">
        <v-img
          class="mt-8 mx-auto"
          src="../assets/screenshots/comps.png"
          width="100%"
          max-width="900px"
        />
        <v-img
          src="../assets/screenshots/comp-settings.png"
          width="100%"
          max-width="60%"
          class="justify-center mx-auto mt-4"
        />
      </div>
    </div>
  ...
  <div class="content">
    <h2 class="headline-feature text-center">
      <span
        class="gradient-base"
        style="background-image: linear-gradient(135deg, #00ffc9, #82ff8f)"
        >灵活</span
      >
      <span>的课表管理</span>
    </h2>
  ...
  <v-sheet class="content">
    <h2 class="headline-feature text-center">
      <span
        class="gradient-base"
        style="background-image: linear-gradient(135deg, #c93bff, #8b3bff)"
        >智能</span
      >
      <span>的自动行为</span>
    </h2>
  ...
  <div class="content">
    <h2 class="headline-feature text-center">
      <span
        class="gradient-base"
        style="background-image: linear-gradient(135deg, #fcf33a, #ffdd3b)"
        >自由</span
      >
      <span>的定制能力</span>
    </h2>
      ...
      <div class="d-flex flex-column flex-wrap ga-4 flex-lg-wrap">
        ...
        <div class="d-flex ga-2 flex-wrap align-content-start">
          ...
          <PluginCard
            ...
            author="ClassIsland"
            url="https://github.com/ClassIsland/ClassIsland.ThemeLoader/"
            description="向 ClassIsland 加载自定义的主题，个性化您的界面。"
            icon="https://github.com/ClassIsland/ClassIsland.ThemeLoader/raw/master/ClassIsland.ThemeLoader/icon.png"
          />
          <PluginCard
            title="地震预警"
            author="电排骨"
  ...
  <v-sheet class="content">
    <h2 class="headline-feature text-center">
      <span
        class="gradient-base"
        style="background-image: linear-gradient(135deg, #ff7900, #ffa100)"
        >可靠</span
      >
      <span>的运行保障</span>
    </h2>
...
.introduction-container {
  ...
  @media (max-width: 1200px) {
    background-image: linear-gradient(135deg, #26c4ce11, #00000000, #00000000, #00000000),
      url('../assets/Banner-Web-24-b.png');
  }
  @media (max-width: 1000px) {
    background-image: linear-gradient(135deg, #26c4ce11, #00000000, #00000000, #00000000);
  }
